    ...
    >
      ...
      <div className="bg-white/10 backdrop-blur-md rounded-3xl shadow-xl p-14 w-[90%] md:w-[700px] lg:w-[850px] text-center border border-white/20">
        ...
        <div className="flex gap-6 justify-center">
          <Link
            to="/login"
            className="bg-[#4C763B] text-white px-10 py-4 rounded-full text-lg font-semibold tracking-wide hover:bg-[#3B5E2F] transition-all duration-300 shadow-md hover:shadow-lg"
          >
            Log In
          </Link>
